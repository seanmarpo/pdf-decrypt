...
function buildCJS() {
  ...
  aes +=
    "\nmodule.exports = { sha256, sha384, sha512, aes128CbcEncrypt, aes128CbcDecrypt, importAES128DecryptKey, aes128CbcDecryptWithKey, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat };\n";

  let main = pdfDecrypt
    .replace(
      /import\s*\{[\s\S]*?\}\s*from\s*["']pdf-lib["'];/,
      "const { PDFDocument, PDFName, PDFHexString, PDFString, PDFDict, PDFArray, PDFRawStream, PDFNumber, PDFRef } = require('pdf-lib');",
    )
    .replace(
      /import\s*\{[\s\S]*?\}\s*from\s*["']\.\/crypto-rc4\.js["'];/,
      "const { md5, RC4, hexToBytes, bytesToHex } = require('./crypto-rc4.js');",
    )
    .replace(
      /import\s*\{[\s\S]*?\}\s*from\s*["']\.\/crypto-aes\.js["'];/,
      "const { sha256, aes128CbcDecrypt, importAES128DecryptKey, aes128CbcDecryptWithKey, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat } = require('./crypto-aes.js');",
    )
    .replace(/^export\s+async\s+function/gm, "async function");
...
const { md5, RC4, hexToBytes, bytesToHex } = require('./crypto-rc4.js');
const { sha256, sha384, sha512, aes128CbcDecrypt, importAES128DecryptKey, aes128CbcDecryptWithKey, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat } = require('./crypto-aes.js');

module.exports = { decryptPDF, isEncrypted, md5, RC4, hexToBytes, bytesToHex, sha256, sha384, sha512, aes128CbcDecrypt, importAES128DecryptKey, aes128CbcDecryptWithKey, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat };
`.trim() + "\n";
...
export { sha256, sha384, sha512, aes128CbcDecrypt, importAES128DecryptKey, aes128CbcDecryptWithKey, aes256CbcDecrypt, aes256CbcDecryptNoPad, aes256EcbDecryptBlock, importAES256DecryptKey, aes256CbcDecryptWithKey, computeHash2B, concat } from './crypto-aes.mjs';
`.trim() + "\n";
...
export declare function aes128CbcDecrypt(data: Uint8Array, key: Uint8Array, iv: Uint8Array): Promise<Uint8Array>;
export declare function importAES128DecryptKey(key: Uint8Array): Promise<CryptoKey>;
export declare function aes128CbcDecryptWithKey(data: Uint8Array, cryptoKey: CryptoKey, iv: Uint8Array): Promise<Uint8Array>;
